...
.PHONY: kano-keys-pressed kano-splash kano-launcher kano-logging kano-networking kano-python parson

all: kano-keys-pressed kano-splash kano-launcher kano-networking kano-python parson
